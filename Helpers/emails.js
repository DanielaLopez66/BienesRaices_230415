...
const registerEmail = async (data) => {
    ...
    await transport.sendMail({
        from: 'BienesRaices_230415',
        to: email,
        subject: 'Confirma tu cuenta...',
        text: `Estimado ${name}, es necesario que confirme su cuenta para poder acceder a BienesRaices_230415.`,
        html: `
  ...
  <img src="https://lh3.googleusercontent.com/pw/AP1GczMr01NFr2UJP8GHZcxrd0oNo7ZyRjzgzojXCGJqi0L4mEo0aNn5ExVtWT6UkpBW3MzdolQu98pZlOl4_z5x1UjVyXQ_y378bWeDFVUy3bZg7PGHwjmhZt77VeQVI4FkZtMgkWWROGvUJfL-o0LmCMZb=w374-h49-s-no-gm?authuser=0" alt="Firma de Ana Daniela López Neri" />
            ...
            <footer style="text-align: center;">
                @Todos los derechos reservados de BienesRaices_230415
            </footer>
        `,
    });
}    
...
const passwordRecoveryEmail = async (data) => {
    ...
    await transport.sendMail({
        ...
        text: `Estimado ${name}, haz solicitado el cambio de contraseña de tu cuenta en BienesRaices_230415.`,
        html: `
            <header style="font-family: bold; text-align: center; line-height: 0.5;">
                <h2>Bienes Raices</h2>
